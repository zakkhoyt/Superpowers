...
@interface VWWFullScreenViewController ()<PHPhotoLibraryChangeObserver>
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([segue.identifier isEqualToString:VWWSegueFullToEdit]){
        ...
        vc.inAppImage = self.currentImage;
        vc.inAppLocation = self.asset.location;
    }
}
